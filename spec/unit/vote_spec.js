...
describe("Vote", () => {
  ...
  beforeEach((done) => {
 // #2  Define the variables that we will use throughout the tests
    this.user;
    this.topic;
    this.post;
    this.vote;
 ...
 // #3  Clear the database and create the objects we will use in our tests
  ...
  // #1  Define a suite for the 'create' action
   ...
   // #2 Write a test to check that we successfully create an upvote
       it("should create an upvote on a post for a user", (done) => {

   // #3  Create an upvote for this.vote by 'this.user'
         Vote.create({
           value: 1,
           postId: this.post.id,
           userId: this.user.id
   ...
   // #4  Ensure the vote was successfully created
   ...
   // #5  Repeat for tests for a downvote.
   ...
   // #6 Check that a vote is not created without a 'userId' or 'postId'
