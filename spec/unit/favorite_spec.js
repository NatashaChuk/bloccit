...
describe("Favorite", () => {
 ...
 beforeEach((done) => {
// #2  Define the variables that will use throughout the tests
   this.user;
   this.topic;
   this.post;
   this.favorite;

// #3  Clear the database and create the objects we will use in our tests
 ...
 // tests here
// #1  Define a suite for the 'create' action
    describe("#create()", () => {

 // #2  Write a test to check that we create a favorite successfully
     it("should create a favorite for a post on a user", (done) => {

 // #3  Create a favorite for 'this.post' and 'this.user'
       Favorite.create({
         postId: this.post.id,
         userId: this.user.id
       })
 ...
 // #4  Ensure to create a favorite successfully
 ...
 // #5  Check we do not create a favorite without a 'userId' or 'postId'
     ...
     //# 1  Define a suite for the 'setUser' method
   describe("#setUser()", () => {
  ...
  // #2  Define a suite for the 'getUser' method
   describe("#getUser()", () => {
    ...
    // #1  Define a suite for the 'setPost' method
   describe("#setPost()", () => {
 ...
 // #2 Define a suite for the 'getPost'method
   describe("#getPost()", () => {
