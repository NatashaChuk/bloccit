...
// #2  Define variables to use in tests
   this.user;
   this.topic;
   this.post;
...
//guest user
 // #1 Define a suite to describe a guest user attempting to favorite a post
...
// #2 Take note of the # of favorites that exist for the post before sending the delete request
// then check tha tthe number of favorites has not changed to confirm no favorite was deleted
...
//signed in user
  ...
  // #1  Define a suite to describe a signed in user attempting to favorite a post
